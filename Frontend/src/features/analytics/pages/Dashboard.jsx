...
const Stat = ({
  ...
  <div className="bg-white border border-zinc-200 p-5" data-testid={testid}>
    ...
    <div
      className={`text-3xl font-black tracking-tighter tabular-nums ${accent}`}
    >
      {value}
      {suffix && (
    ...
    <div className="p-6 space-y-6 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs font-bold text-zinc-500 uppercase tracking-tight">
            Greetings, {user?.name?.split(" ")[0]}. Overview of{" "}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Stat
          ...
          icon={AlertTriangle}
          accent={overview?.active ? "text-red-700" : "text-zinc-950"}
          testid="stat-active"
        />
        <Stat
          label="Total"
        ...
        <div className="lg:col-span-2 bg-white border border-zinc-200">
          <div className="px-5 py-3 border-b border-zinc-200 flex items-center justify-between">
            ...
            <Link
              ...
              data-testid="dashboard-view-all-incidents"
            >
