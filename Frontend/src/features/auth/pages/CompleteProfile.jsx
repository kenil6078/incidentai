    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#FAFAFA] selection:bg-black selection:text-white overflow-hidden">
      ...
      <div className="flex flex-col items-center px-8 sm:px-16 lg:px-24 py-20 relative h-screen overflow-y-auto custom-scrollbar">
        <div className="max-w-md w-full space-y-10">
          <header className="space-y-2">
            <div className="inline-block px-3 py-1 bg-black text-white text-[10px] font-black uppercase tracking-[0.2em] mb-4">
              Final Step
            </div>
              ...
              {!user?.hasPassword && (
                <div className="space-y-4">
                  <div className="p-4 bg-[#FDE68A] border-2 border-black flex items-start gap-3">
                    ...
                    <p className="text-[10px] font-black leading-snug uppercase italic">
                      Important: Since you used Google, please set a password
                      for manual login backup.
                    </p>
                  </div>

                  <div className="space-y-4">
                    <div className="relative group">
                      <label className="block text-[10px] font-mono uppercase tracking-widest text-zinc-500 font-black mb-1.5 ml-1">
                        Create Password
                      </label>
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-[#D4F4E4] border-l-4 border-black p-12 relative overflow-hidden h-screen">
        ...
        <div className="relative z-10 text-center space-y-8">
          ...
          <div>
            <h2 className="text-4xl font-black italic tracking-tighter uppercase text-black leading-none">
              Security
              <br />
              First.
            </h2>
            <p className="mt-4 text-sm font-bold text-zinc-600 max-w-xs mx-auto">
              Choose your role carefully. Admins manage teams, while Developers
