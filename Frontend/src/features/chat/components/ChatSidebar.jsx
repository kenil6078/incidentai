...
export default function ChatSidebar() {
  ...
  }, [chats, user, debouncedSearchTerm]);
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-baseline">
                        ...
                        {chat.lastMessage && (
                          <div className="text-[10px] font-mono text-zinc-500 flex-shrink-0 ml-2">
                      ...
                      <div className="flex items-center justify-between mt-0.5">
                        <div className="text-xs text-zinc-500 truncate flex-1 mr-2">
                          {chat.lastMessage ? (
                            <span className={isActive ? 'text-black' : ''}>
                              {(chat.lastMessage.sender?._id === user._id || chat.lastMessage.sender === user._id) ? 'You: ' : ''}
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 p-1 hover:bg-red-50 text-zinc-400 hover:text-red-600 transition-all flex-shrink-0"
                          title="Delete Chat"
                        >
